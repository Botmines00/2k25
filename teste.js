// Chefe 2k25 - Script Completo com borda neon vermelha, 💸 confete, status online e lógica Win/Loss
...
(() => {
  ...
  function criarTile(numero) {
    ...
    if (numero === 0) tile.style.backgroundImage = 'none';
  ...
  style.textContent = `
    ...
    #blazeMenu {
      ...
      padding: 10px; z-index: 99999; touch-action: none;
  ...
  menu.addEventListener('touchstart', e => { const touch = e.touches[0]; startDrag(touch.clientX, touch.clientY); e.preventDefault(); }, { passive: false });

  document.addEventListener('touchmove', e => { const touch = e.touches[0]; drag(touch.clientX, touch.clientY); }, { passive: false });
